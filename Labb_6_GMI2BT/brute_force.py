...
def init_globals(key_not_found, key, key_found):
...
def hacking_pw(KEY):
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=cpu_count, initializer=init_globals, initargs=(key_not_found, KEY, key_found)) as executor:
